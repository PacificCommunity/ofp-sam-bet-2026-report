...
\caption{Tag-reporting-rate groups, release coverage and estimation status. For groups spanning RTTP and PTTP, the same group number is also assigned to the extra pooled row of the MFCL reporting-rate matrix; pooled is not a tag programme.}\label{tbl-tag-definitions}\\
\toprule
