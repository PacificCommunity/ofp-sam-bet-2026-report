...
The assessment provides the report, model diagnostics and uncertainty
...
The report builds from a standalone clone with all publication assets
checked in. Automated builds use the pinned container
\inlinecode{ghcr.io/pacificcommunity/tuna-flow-private:v2.7@sha256:4fee4c40cb6439ff920b1dd233a84bf19d5cc0e37278c99ceff3fd79cb9c8852};
...
quantity--year points (87.9\%). Median relative errors for recent and
native assessment summaries ranged from -2.1\% to 3.5\%; across selected
recruitment-scale, growth and stock--recruitment parameters they ranged
from -3.85\% to 2.00\% (Figure~\ref{fig-selftest-diagnostics}).
Consistent with the purpose of a self-test (Deroba et al., 2015; Kim et
al., 2024), these results show that the configured model can recover its
...
(Figure~\ref{fig-natm-at-age}) had the scale set by the fixed M at age
...
period. Otherwise, retained models were distributed across the levels of
each uncertainty component. Equal total model weights prevented these
differences in retention from giving greater influence to categories
containing more retained models.
...
\caption{\label{fig-selftest-diagnostics}Self-test results from 50
...
\subsection{Interactive supporting
resources}\label{sec-interactive-resources}

The following self-contained browser reports provide selectable model
...
\item
  ...
  model-development viewer}: comparison of the 2023 refit, intermediate
  development steps and the 2026 diagnostic model.
\item
  \href{https://pacificcommunity.github.io/ofp-sam-bet-2026-diagnostic/bet-2026-diagnostic-report.html}{Diagnostic
  report}: model-fit, population-dynamics, diagnostic and configuration
...
\item
  ...
  viewer}: selectable overall and component profiles. CPUE can be
...
\item
  \href{https://pacificcommunity.github.io/ofp-sam-bet-2026-jitter/jitter-report.html}{Jitter
  diagnostics}: convergence, objective-function and derived-quantity
  results for dispersed starting values.
\item
  \href{https://pacificcommunity.github.io/ofp-sam-bet-2026-selftest/selftest-report.html}{Self-test
  diagnostics}: simulation-estimation recovery summaries and
  replicate-level results.
\item
  \href{https://pacificcommunity.github.io/ofp-sam-bet-2026-retrospective/retrospective-report.html}{Retrospective
  diagnostics}: seven terminal-year peels, trajectories and Mohn's
  \(\rho\) summaries.
\item
  \href{https://pacificcommunity.github.io/ofp-sam-bet-2026-sensitivity/bet-2026-sensitivity-interactive-viewer.html}{One-off
  sensitivity viewer}: comparison of the diagnostic model with the
  one-off sensitivity models.
\item
  \href{https://pacificcommunity.github.io/ofp-sam-bet-2026-ensemble/bet-2026-ensemble-interactive-viewer.html}{Uncertainty-ensemble
  viewer}: retained-model design, management quantities and ensemble
