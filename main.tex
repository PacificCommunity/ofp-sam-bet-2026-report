...
2021--2024, and 2024 respectively (Table~\ref{tbl-ref-points}).
...
The constant-recruitment age-structured production model (ASPM) provided
...
Table~\ref{tbl-manage-quant}, Table~\ref{tbl-stock-status-refs},
Table~\ref{tbl-ref-points} and Table~\ref{tbl-est-uncertainty}, the
time-series uncertainty in Figure~\ref{fig-ensemble-est-uncert-ribbon},
and the dynamic Majuro and Kobe plots in
...
2030 to 720.6 thousand t in 2054. These are conditional projections
...
The ensemble median recent depletion was 0.277, with a central 80\%
...
\item
  CMM 2025-02 contains an objective to maintain depletion at or above
  the 2012--2015 average. The ensemble median of that benchmark is
  0.296, compared with median recent depletion of 0.277.
\item
  Median recent fishing mortality (2020--2023),
...
We thank WCPFC members, participating territories and other providers
for the fisheries data, and the observers, port samplers, tagging teams
and fishers who collected the biological and tagging observations. We
also acknowledge the 2026 Pre-assessment Workshop participants and the
Pacific Community data, assessment and software teams for their
contributions.
...
\href{https://pacificcommunity.github.io/ofp-sam-bet-2026-ensemble/bet-2026-ensemble-report.html\#fig-natural-mortality-evidence}{ensemble
report}.}
