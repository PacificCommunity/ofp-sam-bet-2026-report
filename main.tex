...
Two depletion quantities were used for management reporting. The
WCPFC-adopted limit reference point (LRP) for bigeye is
...
2012--2015 average. This comparison used the 80 equal-weight central
models and excluded estimation uncertainty; the result is reported in
Table~\ref{tbl-cmm-depletion}, with the other management and
