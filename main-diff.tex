...
%DIF DEL /tmp/tmp.2mV4uyVtvy/draft/main.tex                              Sun Aug  9 05:29:08 2026
%DIF ADD /__w/ofp-sam-bet-2026-report/ofp-sam-bet-2026-report/main.tex   Sun Aug  9 05:26:34 2026
% Options for packages loaded elsewhere
...
Old: /tmp/tmp.2mV4uyVtvy/draft/main.tex                              Sun Aug  9 05:29:08 2026
New: /__w/ofp-sam-bet-2026-report/ofp-sam-bet-2026-report/main.tex   Sun Aug  9 05:26:34 2026\end{verbatim}
...
\DIFaddbegin \Needspace{6\baselineskip}

\DIFaddend \textbf{Stock status management quantities}
...
\item
  ...
  depletion ratio \DIFaddbegin \DIFadd{at or }\DIFaddend above the average \DIFdelbegin \DIFdel{for 2012-2015,
  ...
  below
  this objective }\DIFdelend \DIFaddbegin \DIFadd{\(SB/SB_{F=0}\) for
  ...
  the objective (Table~\ref{tbl-cmm-depletion})}\DIFaddend .
\item
...
\DIFadd{The assessment results and supporting analyses can be opened directly:
}

\begin{itemize}
\item
  \textbf{\DIFadd{Assessment:}}
  \href{https://pacificcommunity.github.io/ofp-sam-bet-2026-report/}{\DIFadd{clean
  report}}\DIFadd{.
}\item
  \textbf{\DIFadd{Model development and fit:}}
  ...
  \textbf{\DIFadd{Model diagnostics and sensitivities:}}
  \href{https://pacificcommunity.github.io/ofp-sam-bet-2026-jitter/jitter-report.html}{\DIFadd{jitter}}\DIFadd{,
  }\href{https://pacificcommunity.github.io/ofp-sam-bet-2026-selftest/selftest-report.html}{\DIFadd{self-test}}\DIFadd{,
  ...
  sensitivity viewer}}\DIFadd{.
}\item
  \textbf{\DIFadd{Management uncertainty and projections:}}
  \href{https://pacificcommunity.github.io/ofp-sam-bet-2026-ensemble/bet-2026-ensemble-interactive-viewer.html}{\DIFadd{ensemble
  viewer}}\DIFadd{.
}\end{itemize}

\DIFadd{The corresponding repositories and pinned build environment are
...
\DIFaddbegin \DIFadd{The correspondence between the former nine-region structure and the five
regions used in 2026 is shown explicitly in
Figure~\ref{fig-map-spatial-comparison}.
}

\DIFaddend \subsection{Temporal stratification}\label{sec-temporal-stratification}
...
data are not very informative about \DIFdelbegin \DIFdel{the steepness parameter of the SRR
parameters }\DIFdelend \DIFaddbegin \DIFadd{steepness }\DIFaddend (ISSF, 2011); hence, \DIFdelbegin \DIFdel{the steepness parameter }\DIFdelend \DIFaddbegin \DIFadd{it
}\DIFaddend was fixed at \DIFdelbegin \DIFdel{a
...
(}\DIFdelend \DIFaddbegin \DIFadd{0.90 in the diagnostic model and sensitivity analyses used
values of }\DIFaddend 0.65\DIFdelbegin \DIFdel{) and higher (}\DIFdelend \DIFaddbegin \DIFadd{, 0.80 and }\DIFaddend 0.95\DIFdelbegin \DIFdel{) values}\DIFdelend . The high CV (2.2) of the \DIFaddbegin \DIFadd{annual
}\DIFaddend log-recruitment \DIFdelbegin \DIFdel{deviates, computed annually, }\DIFdelend \DIFaddbegin \DIFadd{deviations }\DIFaddend ensured that the SRR had negligible \DIFdelbegin \DIFdel{impact on the estimation of }\DIFdelend \DIFaddbegin \DIFadd{influence
on }\DIFaddend recruitment and other model \DIFdelbegin \DIFdel{parameters}\DIFdelend \DIFaddbegin \DIFadd{estimates}\DIFaddend , as recommended by Ianelli et
al. (2012).
\DIFdelbegin \DIFdel{The SRR was
...
sex-ratio at length, a growthcurve, a base \(M\) assumption for males, assumptions on critical lengthsfor inflections and a multiplier that
...
is assumed to be }\DIFdelend \DIFaddbegin \DIFadd{estimates. The number of spline nodes was chosen to
...
Selectivity was }\DIFaddend time-invariant and fishery-specific \DIFdelbegin \DIFdel{. However, a single
...
bias estimation of management quantities (Kolody \& Hoyle, \DIFdelbegin \DIFdel{2014}\DIFdelend \DIFaddbegin \DIFadd{2015}\DIFaddend ). Mixing
...
evaluated values including 10, 25}\DIFaddend , \DIFdelbegin \DIFdel{000), which resulted in deterioration of the fits to the abundance
...
the Francis weight method }\DIFdelend \DIFaddbegin \DIFadd{40, 100 and the MFCL default of
...
\textbf{ASPM} \DIFdelbegin \DIFdel{ASPM diagnostics }\DIFdelend \DIFaddbegin \DIFadd{A strict age-structured production model (ASPM) diagnostic
}\DIFaddend (Carvalho et al., 2017\DIFaddbegin \DIFadd{; Carvalho et al.}\DIFaddend , 2021; Maunder \DIFdelbegin \DIFdel{and
}\DIFdelend \DIFaddbegin \DIFadd{\& }\DIFaddend Piner, 2015;
Minte-Vera et al., \DIFdelbegin \DIFdel{2017) for the diagnostic case model were
estimated by 1) fixing growth and selectivity parameters at their
estimated values; 2) removing the LF data from the model, leaving only the CPUE indices and tagging data as data to be fitted; 3) recruitment
is calculated deterministically from the stock-recruit relationship }\DIFdelend \DIFaddbegin \DIFadd{2021) was fitted by conditioning on the observed
catches and retaining only the five CPUE indices in the observation
likelihood. Tagging, length- and weight-frequency}\DIFaddend , \DIFdelbegin \DIFdel{4)
re-fitting the model estimating only the population scaling parameters. A comparison of biomass and depletion scaling and trends estimated by
the ASPM and the
full model gives an indication of the extent to which
these estimates are informed by the CPUE indices and tagging data only.
A second version of the ASPM, in which recruitment
variability was
estimated as for the diagnostic case, was also run (Section}\DIFdelend \DIFaddbegin \DIFadd{catch-at-age,
...
(}\DIFaddend Section~\ref{sec-aspm}).
...
calculated given the estimated recruitments and the \DIFdelbegin \DIFdel{Beverton-Holt SRR.
This offers a basis for comparing the exploited population relative to
the
population subject to natural mortality only
i.e.
~\(SB\)/\(SB_{F=0}\). The WCPFC adopted }\DIFdelend \DIFaddbegin \DIFadd{Beverton--Holt SRR.
...
\DIFadd{Two related but distinct depletion quantities were used for management
reporting. The WCPFC-adopted }\DIFaddend limit reference point (LRP) for \DIFdelbegin \DIFdel{the bigeye stock is
\(SB_{recent}\)/\(SB_{F=0}\)=0.20.
\(SB_{recent}\) refers to the average spawning
biomass across year
}\DIFdelend \DIFaddbegin \DIFadd{bigeye is
\(SB_{recent}/SB_{F=0}=0.20\), where the numerator is mean spawning
biomass during }\DIFaddend 2021--2024 \DIFdelbegin \DIFdel{, whereas \(SB_{F=0}\) refers to the average unfished biomass
across the years 2014-2023. There is no agreed WCPFC target reference
point for the bigeye tuna stock however }\DIFdelend \DIFaddbegin \DIFadd{and the denominator is mean unfished spawning
biomass during 2014--2023. }\DIFaddend CMM 2025-02 \DIFdelbegin \DIFdel{states in para }\DIFdelend \DIFaddbegin \DIFadd{paragraph }\DIFaddend 10 \DIFdelbegin \DIFdel{``Pending agreement of }\DIFdelend \DIFaddbegin \DIFadd{separately states
that, pending agreement on }\DIFaddend a target reference point\DIFdelbegin \DIFdel{the spawning biomass
depletion ratio (\(SB\)/\(SB_{F=0}\)) }\DIFdelend \DIFaddbegin \DIFadd{, the
spawning-biomass depletion ratio }\DIFaddend is to be maintained at or above \DIFdelbegin \DIFdel{the average \(SB\)/\(SB_{F=0}\) for }\DIFdelend \DIFaddbegin \DIFadd{its
}\DIFaddend 2012--2015 \DIFdelbegin \DIFdel{''. Stock status was referenced against these points by calculating the reference points;
\(SB_{recent}\)/\(SB_{F=0}\) and \(SB_{latest}\)/\(SB_{F=0}\) where
\(SB_{F=0}\) is calculated over 2014--2023 and \(SB_{recent}\) and
\(SB_{latest}\) are the mean of }\DIFdelend \DIFaddbegin \DIFadd{average. This comparison was calculated within each model as
}

\[
\DIFadd{D_y=\frac{SB_y}{\frac{1}{10}\sum_{j=y-10}^{y-1}SB_{j,F=0}},\qquad
D_{recent}=\frac{1}{4}\sum_{y=2021}^{2024}D_y,\qquad
D_{2012\text{--}2015}=\frac{1}{4}\sum_{y=2012}^{2015}D_y,
}\]

\DIFadd{for each of the 80 central models, excluding estimation uncertainty. The
headline comparison is }\DIFaddend the \DIFdelbegin \DIFdel{estimated spawning potential over
2021--2024, and 2024 respectively (Table}\DIFdelend \DIFaddbegin \DIFadd{arithmetic mean of \(D_{recent}\) across the
...
}\DIFaddend Table~\ref{tbl-ref-points}\DIFdelbegin \DIFdel{)}\DIFdelend .
...
were closer to the prior mean, for example groups 10, 7}\DIFdelend , \DIFdelbegin \DIFdel{14 but }\DIFdelend \DIFaddbegin \DIFadd{although }\DIFaddend groups 17 and 18 \DIFdelbegin \DIFdel{wanted }\DIFdelend \DIFaddbegin \DIFadd{favoured }\DIFaddend higher reporting rates.
...
The estimated growth curve for the diagnostic model, which is \DIFdelbegin \DIFdel{based on
}\DIFdelend \DIFaddbegin \DIFadd{informed
by }\DIFaddend both the CAAL \DIFdelbegin \DIFdel{data and the size data}\DIFdelend \DIFaddbegin \DIFadd{and size-composition data, }\DIFaddend is shown in
Figure\DIFdelbegin \DIFdel{Figure}\DIFdelend ~\ref{fig-growth-curve}. \DIFdelbegin \DIFdel{Aggregate }\DIFdelend \DIFaddbegin \DIFadd{Regional }\DIFaddend fits to the
conditional-age-at-length (CAAL) data are shown in
Figure\DIFdelbegin \DIFdel{Figure~\ref{fig-caal-fits}}\DIFdelend \DIFaddbegin \DIFadd{~\ref{fig-caal-fits-regions}}\DIFaddend . For length bins from around 70 to
120 cm, which \DIFdelbegin \DIFdel{constitute most of the observed CAAL data, the model's }\DIFdelend \DIFaddbegin \DIFadd{contain most observations, }\DIFaddend predicted median ages \DIFdelbegin \DIFdel{at lengths fit the observed data very }\DIFdelend \DIFaddbegin \DIFadd{generally
tracked the data }\DIFaddend well. At smaller sizes the model \DIFdelbegin \DIFdel{tends to slightly
over predict the observed }\DIFdelend \DIFaddbegin \DIFadd{tended to slightly
overpredict }\DIFaddend median age, \DIFdelbegin \DIFdel{for
size bins }\DIFdelend \DIFaddbegin \DIFadd{whereas median age was generally underpredicted
}\DIFaddend from around 120 to 150 cm\DIFdelbegin \DIFdel{the model under predicts the median
age, and for the largest sizes, the model prediction is }\DIFdelend \DIFaddbegin \DIFadd{; predictions were }\DIFaddend closer to the \DIFdelbegin \DIFdel{observed median age at length. Overall the fit is reasonable}\DIFdelend \DIFaddbegin \DIFadd{observations
at the largest sizes}\DIFaddend .
...
\DIFdelbegin \DIFdel{quantity-year }\DIFdelend \DIFaddbegin \DIFadd{quantity--year }\DIFaddend points (87.9\%\DIFaddbegin \DIFadd{; Figure~\ref{fig-selftest-time-series}}\DIFaddend ).
Median relative \DIFdelbegin \DIFdel{bias across }\DIFdelend \DIFaddbegin \DIFadd{errors for }\DIFaddend recent and native assessment summaries ranged
from -2.1\% to 3.5\%\DIFdelbegin \DIFdel{. Across the selected }\DIFdelend \DIFaddbegin \DIFadd{; across the selected fitted }\DIFaddend recruitment-scale,
growth and \DIFdelbegin \DIFdel{stock-recruit parameters , median relative errors }\DIFdelend \DIFaddbegin \DIFadd{stock--recruitment parameters they }\DIFaddend ranged from -3.85\% to
2.00\% \DIFdelbegin \DIFdel{. These are empirical simulation-estimation diagnostics under the configured generator, not confidence intervals for the assessment.Self
test was overall successful, the model successful estimated the time
series \(SB\)/\(SB_{F=0}\), \(SB\), recruitment without any consistent bias through the time series.
Median relative bias was less than 5\% for
\(SB\)/\(SB_{F=0}\)}\DIFdelend \DIFaddbegin \DIFadd{(Figure~\ref{fig-selftest-recovery}). Consistent with the purpose
of a self-test (Deroba et al., 2015; Kim et al.}\DIFaddend , \DIFdelbegin \DIFdel{\(SB\), recruitment and around 6-7\% for F, which
...
Figure Figure~\ref{fig-selftest-time-series}}\DIFdelend \DIFaddbegin \DIFadd{2024), these results
...
profile through most of the biomass range , and the region of the overall likelihood. The penalty terms also preferred lower biomass. The
conflict
between the CPUE and tagging indicates that tag data is the key
influence on higher biomass scaling}\DIFdelend \DIFaddbegin \DIFadd{comparatively flat
...
tag programmes (Figure~\ref{fig-diag-profile-data-tag-prog})}\DIFaddend . This
conflict \DIFdelbegin \DIFdel{is accounted for to
...
release group profiles for any of the individual programmes,
}\DIFdelend and \DIFdelbegin \DIFdel{only
...
\DIFadd{The constant-recruitment age-structured production model (ASPM),
...
The \DIFdelbegin \DIFdel{Lorenzen form of natural mortality for the diagnostic model (Figure
Figure~\ref{fig-natm-at-age}) had the scale set by the fixed M at
age 40
quarter of 0.078/}\DIFdelend \DIFaddbegin \DIFadd{diagnostic model fixed the Lorenzen natural-mortality scale at
\(M_{40}=0.07814\) per }\DIFaddend quarter. The \DIFdelbegin \DIFdel{Lorenzen shape of the natural mortality at
age depends on the growth curve estimated in MFCL, and features
considerably higher levels of natural mortality at age for very young fish with quarterly M approaching 0.45 at 1 quarter age, and a lower
asymptote for mortality of the oldest age classes reached the fixed value of 0.078/quarter }\DIFdelend \DIFaddbegin \DIFadd{longevity-based prior followed the
...
young fish and approach their respective fixed scales }\DIFaddend at age 40
quarters\DIFaddbegin \DIFadd{; the diagnostic choice is represented as an uncertainty axis
rather than estimated internally}\DIFaddend .
...
Of the 100 \DIFdelbegin \DIFdel{ensemble model runs}\DIFdelend \DIFaddbegin \DIFadd{planned ensemble configurations}\DIFaddend , 80 met the
\DIFdelbegin \DIFdel{gradient convergence criteria
}\DIFdelend \DIFaddbegin \DIFadd{maximum-gradient-component (MGC) criterion }\DIFaddend \(\leq 1.0 \times 10^{-4}\)\DIFaddbegin \DIFadd{,
}\DIFaddend of which 62 had \DIFdelbegin \DIFdel{positive definite }\DIFdelend \DIFaddbegin \DIFadd{positive-definite }\DIFaddend Hessians. The 80 models were retained
in the ensemble for management advice; \DIFdelbegin \DIFdel{of
the 20 models that failed ten failed the convergence gradient }\DIFdelend \DIFaddbegin \DIFadd{ten did not meet the MGC
}\DIFaddend criterion and ten were incomplete. For the 62 \DIFdelbegin \DIFdel{positive definite }\DIFdelend \DIFaddbegin \DIFadd{positive-definite }\DIFaddend Hessian
...
uncertainty accounted for these difference}\DIFdelend \DIFaddbegin \DIFadd{. The balanced design contained 50 models per reporting-rate
...
explicitly rather than used as an additional weighting criterion}\DIFaddend .
...
}\DIFaddend Table~\ref{tbl-manage-quant}, Table\DIFaddbegin \DIFadd{~\ref{tbl-cmm-depletion},
}\DIFaddend Table~\ref{tbl-stock-status-refs}, Table\DIFdelbegin \DIFdel{Table~\ref{tbl-ref-points} ,
Table }\DIFdelend \DIFaddbegin \DIFadd{~\ref{tbl-ref-points} and
}\DIFaddend Table~\ref{tbl-est-uncertainty}\DIFdelbegin \DIFdel{) and the dynamic spawning
depletion and spawning potential plots for the models in the structural
uncertainty grid (Figure }\DIFdelend \DIFaddbegin \DIFadd{, the time-series uncertainty in
}\DIFaddend Figure~\ref{fig-ensemble-est-uncert-ribbon}, and the dynamic Majuro and
Kobe plots \DIFdelbegin \DIFdel{(Figure
}\DIFdelend \DIFaddbegin \DIFadd{in }\DIFaddend Figure~\ref{fig-time-dynamic-kobe-majuro}\DIFdelbegin \DIFdel{)}\DIFdelend .
...
favourable categories (}\DIFaddend Figure~\ref{fig-combined-kobe-majuro-status}\DIFaddbegin \DIFadd{).
...
the tuna assessment results}\DIFaddend .

\DIFdelbegin \DIFdel{Both the
}\DIFdelend \DIFaddbegin \DIFadd{CMM 2025-02 contains an objective to maintain the spawning biomass
...
\DIFadd{The }\DIFaddend dynamic Majuro and Kobe \DIFdelbegin \DIFdel{plots for }\DIFdelend \DIFaddbegin \DIFadd{trajectories for both }\DIFaddend the diagnostic model
...
from 523.1 thousand t in 2030 }\DIFaddend to \DIFdelbegin \DIFdel{be added
}\DIFdelend \DIFaddbegin \DIFadd{720.6 thousand t in 2054. These are
...
\DIFadd{The ensemble median \(SB_{recent}/SB_{F=0}\) was 0.277, with a central
...
\item
  ...
  \DIFadd{Establish a separate MFCL continuous-integration project that
...
\item
  ...
  depletion ratio above the averagefor 2012-2015, \(SB_{2012-2015}\)/\(SB_{F=0}\), which is a value of 0.296 calculated
  across the ensemble. Based upon the estimates of
  \(SB_{recent}\)/\(SB_{F=0}\) of 0.277 the stock status is marginally
  below this objective }\DIFdelend \DIFaddbegin \DIFadd{spawning depletion at or
  ...
  objective (Table~\ref{tbl-cmm-depletion})}\DIFaddend .
\item
  \DIFdelbegin \DIFdel{Recent }\DIFdelend \DIFaddbegin \DIFadd{Median recent fishing mortality }\DIFaddend (2020--2023)\DIFdelbegin \DIFdel{median fishing mortality
  }\DIFdelend \DIFaddbegin \DIFadd{,
...
}\DIFdelend \DIFaddbegin \DIFadd{We thank WCPFC members, participating territories and other providers of
...
\section{\DIFadd{Statement on the use of generative
AI}}\label{statement-on-the-use-of-generative-ai}

\DIFadd{GitHub Copilot, a generative artificial-intelligence assistant, was used
...
\DIFdelbegin %DIFDELCMD < \begin{longtable}%DIFDELCMD < {@{}>{\raggedright\arraybackslash}p{0.17\linewidth}>{\raggedright\arraybackslash}p{0.25\linewidth}>{\raggedleft\arraybackslash}p{0.08\linewidth}>{\raggedleft\arraybackslash}p{0.13\linewidth}>{\raggedleft\arraybackslash}p{0.13\linewidth}>{\raggedleft\arraybackslash}p{0.13\linewidth}@{}}
%DIFDELCMD < 
%DIFDELCMD < \caption{\label{tbl-manage-quant}Management quantities from the equal-model-weight structural mixture with available Hessian estimation uncertainty. Each of 62 PDH models contributes 100 joint Hessian draws; each of 18 Near-PDH models contributes its central estimate with equal total model weight. Values are the median and central 50\%, 80\% and 95\% equal-tailed intervals. Estimation uncertainty is unavailable for the Near-PDH fits.}
%DIFDELCMD < 
%DIFDELCMD < \tabularnewline
%DIFDELCMD < 
%DIFDELCMD < \\
%DIFDELCMD < \toprule
%DIFDELCMD < Quantity & Period & Median & 50\% interval & 80\% interval & 95\% interval \\
%DIFDELCMD < \midrule
%DIFDELCMD < \endfirsthead
%DIFDELCMD < \toprule
%DIFDELCMD < Quantity & Period & Median & 50\% interval & 80\% interval & 95\% interval \\
...
%DIFDELCMD < \bottomrule
%DIFDELCMD < \endlastfoot
%DIFDELCMD < $SB_{\mathrm{recent}}/SB_{F=0}$ & 2021--2024 / 2014--2023 & 0.277 & 0.217--0.336 & 0.172--0.395 & 0.136--0.442 \\
%DIFDELCMD < $SB_{\mathrm{recent}}/SB_{\mathrm{MSY}}$ & 2021--2024 / equilibrium $SB_{\mathrm{MSY}}$ & 1.532 & 1.136--2.024 & 0.822--2.572 & 0.635--3.519 \\
%DIFDELCMD < $F_{\mathrm{recent}}/F_{\mathrm{MSY}}$ & 2020--2023 / equilibrium $F_{\mathrm{MSY}}$ & 0.838 & 0.702--0.983 & 0.592--1.206 & 0.460--1.351 \\
%DIFDELCMD < $\overline{D}_{2012\text{--}2015}$ & 2012--2015 & 0.296 & 0.221--0.362 & 0.176--0.431 & 0.140--0.490 \\
%DIFDELCMD < $D_{\mathrm{recent}}/\overline{D}_{2012\text{--}2015}$ & Recent / 2012--2015 & 0.949 & 0.920--0.984 & 0.899--1.007 & 0.872--1.038 \\
%DIFDELCMD < 
%DIFDELCMD < \end{longtable}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \begin{longtable}{@{}>{\raggedright\arraybackslash}p{0.17\linewidth}>{\raggedright\arraybackslash}p{0.25\linewidth}>{\raggedleft\arraybackslash}p{0.08\linewidth}>{\raggedleft\arraybackslash}p{0.13\linewidth}>{\raggedleft\arraybackslash}p{0.13\linewidth}>{\raggedleft\arraybackslash}p{0.13\linewidth}@{}}
...
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \vspace{1em}
\DIFaddend 
...
\DIFdelbegin %DIFDELCMD < \begin{longtable}%DIFDELCMD < {@{}>{\raggedright\arraybackslash}p{0.57\linewidth}>{\raggedleft\arraybackslash}p{0.23\linewidth}@{}}
%DIFDELCMD < 
%DIFDELCMD < \caption{\label{tbl-stock-status-refs}Stock status probabilities in relation to reference points and the probability of being below average 2012--2015 depletion objective.}
%DIFDELCMD < 
%DIFDELCMD < \tabularnewline
%DIFDELCMD < 
%DIFDELCMD < \\
%DIFDELCMD < \toprule
%DIFDELCMD < Criterion & Probability \\
%DIFDELCMD < \midrule
%DIFDELCMD < \endfirsthead
%DIFDELCMD < \toprule
%DIFDELCMD < Criterion & Probability \\
...
%DIFDELCMD < \bottomrule
%DIFDELCMD < \endlastfoot
%DIFDELCMD < $SB_{\mathrm{recent}}/SB_{F=0}<0.20$ & 18.6\% \\
%DIFDELCMD < $SB_{\mathrm{recent}}/SB_{\mathrm{MSY}}<1$ & 17.3\% \\
%DIFDELCMD < $F_{\mathrm{recent}}/F_{\mathrm{MSY}}>1$ & 24.1\% \\
%DIFDELCMD < $D_{\mathrm{recent}}<\overline{D}_{2012\text{--}2015}$ & 87.1\% \\
%DIFDELCMD < 
%DIFDELCMD < \end{longtable}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \begin{longtable}{@{}>{\raggedright\arraybackslash}p{0.62\linewidth}>{\raggedleft\arraybackslash}p{0.20\linewidth}@{}}
...
\DIFdelbegin %DIFDELCMD < \begin{longtable}%DIFDELCMD < {@{}rrrrrr>{\raggedleft\arraybackslash}p{0.22\linewidth}rrr@{}}
%DIFDELCMD < 
%DIFDELCMD < \caption{\label{tbl-stock-projections}Projected management quantities at selected years across 80 models and ten recruitment sequences per model. Depletion is the four-year mean spawning biomass divided by the preceding ten-year mean unfished spawning biomass; the LRP is 0.20. Catches are fixed by fishery to their 2022--2024 means, and intervals exclude Hessian parameter uncertainty.}
%DIFDELCMD < 
%DIFDELCMD < \tabularnewline
%DIFDELCMD < 
%DIFDELCMD < \\
%DIFDELCMD < \toprule
%DIFDELCMD < Year & $D$ 10\% & $D$ median & $D$ 90\% & Below LRP & Below objective & Spawning median ($10^3$ MT) & $C/\mathrm{MSY}$ 10\% & $C/\mathrm{MSY}$ median & $C/\mathrm{MSY}$ 90\% \\
%DIFDELCMD < \midrule
%DIFDELCMD < \endfirsthead
%DIFDELCMD < \toprule
%DIFDELCMD < Year & $D$ 10\% & $D$ median & $D$ 90\% & Below LRP & Below objective & Spawning median ($10^3$ MT) & $C/\mathrm{MSY}$ 10\% & $C/\mathrm{MSY}$ median & $C/\mathrm{MSY}$ 90\% \\
...
%DIFDELCMD < \bottomrule
%DIFDELCMD < \endlastfoot
%DIFDELCMD < 2030 & 0.225 & 0.355 & 0.514 & 5.2\% & 6.9\% & 523.1 & 0.638 & 0.811 & 1.003 \\
%DIFDELCMD < 2040 & 0.409 & 0.517 & 0.628 & 0.0\% & 0.0\% & 690.5 & 0.642 & 0.842 & 1.052 \\
%DIFDELCMD < 2054 & 0.455 & 0.545 & 0.641 & 0.0\% & 0.0\% & 720.6 & 0.648 & 0.847 & 1.053 \\
%DIFDELCMD < 
%DIFDELCMD < \end{longtable}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \begin{longtable}{@{}rrrrr>{\raggedleft\arraybackslash}p{0.22\linewidth}rrr@{}}
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/map_5regions.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/catch_hist_regional.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/data_coverage_tile.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/growth_curve.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/maturity_ogive.png}
%DIFDELCMD < 

%DIFDELCMD < }
%DIFDELCMD < 

%DIFDELCMD < \caption{\label{fig-maturity-ogive}Maturity-at-age ogive for the 2026
%DIFDELCMD < diagnostic model.}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/natm_at_age.png}
%DIFDELCMD < 

%DIFDELCMD < }
%DIFDELCMD < 

%DIFDELCMD < \caption{\label{fig-natm-at-age}Lorenzen natural mortality-at-age
%DIFDELCMD < (quarters) for the 2026 diagnostic model, based on M at age 40 quarters
%DIFDELCMD < of 0.078.}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/stepwise_panel_reduce.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/diag_time_series.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/cpue_fit_1_5.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/cpue_resids_1_5.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/length_fit_aggregated_ll.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/length_fit_aggregated_dompl.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/length_fit_aggregated_ps.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/length_fit_time_series_ll.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=0.75\linewidth,height=\textheight,keepaspectratio]{figures/length_fit_time_series_other.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/tag_attrition_all.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/tag_recapture_fit_years_groups.png}
%DIFDELCMD < 
...
\caption{\label{fig-caal-fits-regions}\label{fig-caal-fits}Observed and fitted conditional
...
%DIFDELCMD < \includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{figures/tag_report_rate_rttp_pttp.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/tag_report_rate_jptp.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{figures/caal_aggregate_fits.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{figures/caal_fits_regions.png}
%DIFDELCMD < 

%DIFDELCMD < }
%DIFDELCMD < 

%DIFDELCMD < \caption{\label{fig-caal-fits-regions}\label{fig-caal-fits}Model estimated median age at
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/jitter_scatter_plot.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/jitter_derived_values_diag_panel.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/jitter_regional_depletion.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/selftest_recovery_diag.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/selftest_time_series.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/retrospective_diag_panel.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/diag_profile_data_sources.png}
%DIFDELCMD < 
...
\caption{\label{fig-diag-profile-data-tag-prog}\label{fig-diag-profile-data-tag-prog-grps}Tag likelihood profile by
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/diag_profile_data_tag_programmes.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/diag_profile_data_tag_rel_groups.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{figures/select_age.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{figures/select_length.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/movement_bar_plots.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/recruitment_annual.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/stock_rr.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/F_adult_juv_regions.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/sensitivity_steepness.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/sensitivity_natural_mortality.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/sensitivity_CAAL.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/sensitivity_effort_creep.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/sensitivity_regional_scaling.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/sensitivity_tag_mixing_periods_Kstatistic_cutoff.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/sensitivity_premixing_tag_reporting_rate.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/sensitivity_tag_overdispersion.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/ensemble_individual.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/ensemble_design_retention.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/management-uncertainty-continuous-axes_steep_M.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/management-uncertainty-discrete-axes_tau_mix.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/management-uncertainty-discrete-axes_tag_rep_effcrp.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/ensemble_est_uncert_ribbon.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/combined_kobe_majuro_status.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{figures/time-dynamic-kobe-majuro.png}
%DIFDELCMD < 
...
%DIFDELCMD < \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{figures/impact_region.png}
%DIFDELCMD < 
...
}\DIFdelend \DIFaddbegin \subsection{\DIFadd{No-tagging and alternative-movement model
...
\DIFaddbegin \bibitem[\citeproctext]{ref-carvalho_diagnostic_2017}
\DIFadd{Carvalho, F., Punt, A. E., Chang, Y.-J., Maunder, M. N., \& Piner, K. R.
(2017). Can diagnostic tests help identify model misspecification in
integrated stock assessments? }\emph{\DIFadd{Fisheries Research}}\DIFadd{, }\emph{\DIFadd{192}}\DIFadd{,
...
\DIFaddbegin \bibitem[\citeproctext]{ref-hamel_development_2022}
\DIFadd{Hamel, O. S., \& Cope, J. M. (2022). Development and considerations for
application of a longevity-based prior for the natural mortality rate.
}\emph{\DIFadd{Fisheries Research}}\DIFadd{, }\emph{\DIFadd{256}}\DIFadd{, 106477.
}\url{https://doi.org/10.1016/j.fishres.2022.106477}

\DIFaddend \bibitem[\citeproctext]{ref-hamer_summary_2026}
...
Kolody, D., \& Hoyle, S. (\DIFdelbegin \DIFdel{2014}\DIFdelend \DIFaddbegin \DIFadd{2015}\DIFaddend ). Evaluation of tag mixing assumptions in
western pacific ocean skipjack tuna stock assessment models.
\emph{Fisheries Research}, \emph{\DIFdelbegin \DIFdel{http://dx.doi.org/101016/j.fishres.2014.05.008}%DIFDELCMD < \MBLOCKRIGHTBRACE%%%
\DIFdel{.
}\DIFdelend \DIFaddbegin \DIFadd{163}}\DIFadd{, 127--140.
...
\DIFaddbegin \bibitem[\citeproctext]{ref-maunder_contemporary_2015}
\DIFadd{Maunder, M. N., \& Piner, K. R. (2015). Contemporary fisheries stock
assessment: Many issues still remain. }\emph{\DIFadd{ICES Journal of Marine
Science}}\DIFadd{, }\emph{72}(1)\DIFadd{, 7--18.
}\url{https://doi.org/10.1093/icesjms/fsu015}

\DIFaddend \bibitem[\citeproctext]{ref-mckechnie_sensitivity_2015}
...
\DIFaddbegin \bibitem[\citeproctext]{ref-minte-vera_auxiliary_2021}
\DIFadd{Minte-Vera, C. V., Maunder, M. N., \& Aires-da-Silva, A. (2021).
...
yellowfin tuna in the eastern }{\DIFadd{Pacific}} {\DIFadd{Ocean}}\DIFadd{. }\emph{\DIFadd{ICES Journal of
Marine Science}}\DIFadd{, }\emph{78}(10)\DIFadd{, 3521--3537.
}\url{https://doi.org/10.1093/icesjms/fsab213}

\DIFaddend \bibitem[\citeproctext]{ref-mohn_retrospective_1999}
...
\DIFadd{reference models for four pacific tuna species}} \DIFadd{(No.
}{\DIFadd{WCPFC}}\DIFadd{-}{\DIFadd{SC}}\DIFadd{22-2026/}{\DIFadd{EB}}\DIFadd{-}{\DIFadd{IP}}\DIFadd{-04). WCPFC.
