...
%DIF DEL /tmp/tmp.2iag0FOPh5/draft/main.tex                              Mon Aug 10 02:49:09 2026
%DIF ADD /__w/ofp-sam-bet-2026-report/ofp-sam-bet-2026-report/main.tex   Mon Aug 10 02:46:33 2026
% Options for packages loaded elsewhere
...
Old: /tmp/tmp.2iag0FOPh5/draft/main.tex                              Mon Aug 10 02:49:09 2026
New: /__w/ofp-sam-bet-2026-report/ofp-sam-bet-2026-report/main.tex   Mon Aug 10 02:46:33 2026\end{verbatim}
...
reviews of approaches for estimating \(M\) have also, where possible, favoured estimating \(M\) within the model, ``let the data speak for
...
i.e.
~\(SB\)/\(SB_{F=0}\). The
WCPFC adopted }\DIFdelend \DIFaddbegin \DIFadd{Beverton--Holt SRR.
...
\DIFadd{Two depletion quantities were used for management reporting. The
WCPFC-adopted }\DIFaddend limit reference point (LRP) for \DIFdelbegin \DIFdel{the bigeye stock is
...
}\DIFaddend 2012--2015 \DIFdelbegin \DIFdel{''. Stock status was
referenced against these points by calculating the reference points;
\(SB_{recent}\)/\(SB_{F=0}\) and \(SB_{latest}\)/\(SB_{F=0}\) where
\(SB_{F=0}\) is calculated over 2014--2023 and \(SB_{recent}\) and \(SB_{latest}\) are the mean of the estimated spawning potential over
2021--2024, and 2024 respectively (Table}\DIFdelend \DIFaddbegin \DIFadd{average. This comparison used the 80 equal-weight central
...
\DIFdelbegin \DIFdel{Both the }\DIFdelend \DIFaddbegin \DIFadd{CMM 2025-02 contains an objective to maintain the spawning biomass
