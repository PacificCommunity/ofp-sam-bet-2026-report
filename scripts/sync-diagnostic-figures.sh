...
asset_map=(
  ...
  "figures/stock-recruitment.png|figures_new/stock-recruitment.png"
  ...
  "mfclshiny/figures/age-data-growth-by-region.png|figures_new/age-data-growth-by-region.png"
  "mfclshiny/figures/length-frequency.png|figures_new/length-frequency-fit-by-fishery.png"
  "mfclshiny/figures/length-frequency-fit-by-region.png|figures_new/length-frequency-fit-by-region.png"
