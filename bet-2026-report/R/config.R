...
load_report_context <- function(config_file = "report-config.yml") {
  ...
  values <- list(
    ...
    figure_roots = metadata_value("figure_roots", "Figures"),
    extra_figure_roots = metadata_value("extra_figure_roots", "Figures"),
    table_roots = metadata_value("table_roots", "tables"),
